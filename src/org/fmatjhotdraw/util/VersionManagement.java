...
public class VersionManagement {
	public static String JHOTDRAW_COMPONENT = "org.fmatjhotdraw/";
	public static String JHOTDRAW_JAR = "fmatjhotdraw.jar";
	
	public static Package[] packages = {
			Package.getPackage("org.fmatjhotdraw.applet"),
			Package.getPackage("org.fmatjhotdraw.application"),
			Package.getPackage("org.fmatjhotdraw.contrib"),
			Package.getPackage("org.fmatjhotdraw.figures"),
			Package.getPackage("org.fmatjhotdraw.framework"),
			Package.getPackage("org.fmatjhotdraw.standard"),
			Package.getPackage("org.fmatjhotdraw.util")
		};
...
//		Package pack = VersionManagement.class.getPackage();
	 ...
	 * specifier without the latest package name, e.g. the next package for "org.fmatjhotdraw.tools"
	 * would be "org.fmatjhotdraw".
	 *
