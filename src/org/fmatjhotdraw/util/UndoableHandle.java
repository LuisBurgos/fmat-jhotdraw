...
import org.fmatjhotdraw.framework.Handle;
...
public class UndoableHandle implements Handle {
	 ...
	 * @see org.fmatjhotdraw.framework.Handle#locate()
	 */
	public Point locate() {
	 ...
	 * @see org.fmatjhotdraw.framework.Handle#invokeStart(int, int, org.fmatjhotdraw.framework.DrawingView)
	 */
	 ...
	 * @param x the x position where the interaction started
	 * @param y the y position where the interaction started
	 * @see org.fmatjhotdraw.framework.Handle#invokeStart(int, int, org.fmatjhotdraw.framework.Drawing)
	 ...
	 * @see org.fmatjhotdraw.framework.Handle#invokeStep(int, int, int, int, org.fmatjhotdraw.framework.DrawingView)
	 */
	 ...
	 * @see org.fmatjhotdraw.framework.Handle#invokeStep(int, int, org.fmatjhotdraw.framework.Drawing)
	 * @deprecated As of version 4.1,
	 ...
	 * @param anchorX the x position where the interaction started
	 * @param anchorY the y position where the interaction started
	 * @see org.fmatjhotdraw.framework.Handle#invokeEnd(int, int, int, int, org.fmatjhotdraw.framework.DrawingView)
	 */
	...
	/**
	 * Tracks the end of the interaction.
	 * @see org.fmatjhotdraw.framework.Handle#invokeEnd(int, int, org.fmatjhotdraw.framework.Drawing)
	 * @deprecated As of version 4.1,
	 ...
	 * @see org.fmatjhotdraw.framework.Handle#owner()
	 */
	public Figure owner() {
	 ...
	 * @see org.fmatjhotdraw.framework.Handle#displayBox()
	 */
	 ...
	 * @see org.fmatjhotdraw.framework.Handle#containsPoint(int, int)
	 */
	...
	/**
	 * Draws this handle.
	 * @see org.fmatjhotdraw.framework.Handle#draw(java.awt.Graphics)
	 */
	...
	/**
	 * @see org.fmatjhotdraw.framework.Handle#getUndoActivity()
	 */
	...
	/**
	 * @see org.fmatjhotdraw.framework.Handle#setUndoActivity(org.fmatjhotdraw.util.Undoable)
	 */
	...
	/**
	 * @see org.fmatjhotdraw.framework.Handle#getCursor()
	 */
