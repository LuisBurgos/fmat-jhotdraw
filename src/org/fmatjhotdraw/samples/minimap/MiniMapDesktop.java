 ...
 */
package org.fmatjhotdraw.samples.minimap;

import org.fmatjhotdraw.contrib.SplitPaneDesktop;
import org.fmatjhotdraw.contrib.MiniMapView;
import org.fmatjhotdraw.framework.DrawingView;
import org.fmatjhotdraw.util.Iconkit;
import org.fmatjhotdraw.figures.ImageFigure;
...
public class MiniMapDesktop extends SplitPaneDesktop {
	...
	protected Component createRightComponent(DrawingView view) {
		...
		view.checkDamage();
//		((org.fmatjhotdraw.standard.StandardDrawingView)view).checkMinimumSize();
