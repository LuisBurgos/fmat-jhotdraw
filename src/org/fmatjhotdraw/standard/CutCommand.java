...
import org.fmatjhotdraw.util.UndoableAdapter;

/**
 * Delete the selection and move the selected figures to
 * the clipboard.
 *
 * @see org.fmatjhotdraw.util.Clipboard
 *
...
public class CutCommand extends FigureTransferCommand {
	...
	/**
	 * @see org.fmatjhotdraw.util.Command#execute()
	 */
	public void execute() {
		super.execute();
	...
	/**
	 * @see org.fmatjhotdraw.standard.AbstractCommand#isExecutableWithView()
	 */
	...
	public static class UndoActivity extends UndoableAdapter {
		...
		/**
		 * @see org.fmatjhotdraw.util.Undoable#undo()
		 */
		public boolean undo() {
		...
		/**
		 * @see org.fmatjhotdraw.util.Undoable#redo()
		 */
		public boolean redo() {
		...
		/**
		 * @see org.fmatjhotdraw.util.UndoableAdapter#release()
		 */
		public void release() {
			super.release();
