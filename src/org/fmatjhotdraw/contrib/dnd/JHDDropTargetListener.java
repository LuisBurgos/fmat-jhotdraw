...
package org.fmatjhotdraw.contrib.dnd;

import org.fmatjhotdraw.framework.*;
import org.fmatjhotdraw.standard.DeleteFromDrawingVisitor;
import java.io.File;
...
////////////////////////////////////////////////////////////////////////////////
	...
	public static class AddUndoActivity extends org.fmatjhotdraw.util.UndoableAdapter {
		...
		public boolean undo() {
			...
			while (fe.hasNextFigure()) {
	    		org.fmatjhotdraw.framework.Figure f = fe.nextFigure();
		...
		public void release() {
			...
			setAffectedFigures(org.fmatjhotdraw.standard.FigureEnumerator.getEmptyEnumeration());
		}
	}
